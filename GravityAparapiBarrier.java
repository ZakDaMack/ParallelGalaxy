 ...
 * @author up788458
 */
public class GravityAparapiBarrier {
...
//    static double[] az = new double[N];
    public static void main(String args[]) throws Exception {
        ...
        // aparapi cannot handle static variables that are not final
        // Star positions
        ...
        Kernel kernel = new Kernel() {
            ...
            public void run() {
                ...
                // update position
                x[globalid] += (vx[globalid] * DT) + (ax[globalid] * dtSquaredOver2);
                y[globalid] += (vy[globalid] * DT) + (ay[globalid] * dtSquaredOver2);
                z[globalid] += (vz[globalid] * DT) + (az[globalid] * dtSquaredOver2);
                // update velocity halfway
                vx[globalid] += (ax[globalid] * dtOver2);
                vy[globalid] += (ay[globalid] * dtOver2);
                vz[globalid] += (az[globalid] * dtOver2);
